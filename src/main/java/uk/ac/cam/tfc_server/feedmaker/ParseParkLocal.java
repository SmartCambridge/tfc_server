...
public class ParseParkLocal {
    ...
    {
       ArrayList<ParseFeedText.RecordTemplate> cam_park_local = new ArrayList<ParseFeedText.RecordTemplate>();
       ...
       common_fields.add(new ParseFeedText.FieldTemplate("spaces_free","int",null,0,"<strong>"," spaces", false));
       ...
       common_fields.add(new ParseFeedText.FieldTemplate("spaces_free","conditional_fixed_int",null,0,"This car park is full",null,false));
